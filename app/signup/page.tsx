...
import { Eye, EyeOff, Lock, Mail, User, DollarSign, Building } from "lucide-react"
      ...
      <div className="flex-grow flex items-center justify-center py-16 px-4">
        <div className="w-full max-w-6xl flex rounded-xl shadow-lg overflow-hidden">
          ...
          <div className="hidden lg:block lg:w-1/2 relative">
            ...
            <Image
              src="https://images.unsplash.com/photo-1560520653-9e0e4c89eb11?q=80&w=1973&auto=format&fit=crop&ixlib=rb-4.0.3"
            ...
            <div className="absolute inset-0 z-20 flex flex-col justify-center items-center text-white p-12">
              ...
              <h2 className="text-3xl font-bold mb-6 text-center">Join the Business Lending Intelligence Platform</h2>
              <p className="text-white/80 text-lg mb-8 text-center">
                Create your account to access exclusive resources, connect with industry professionals, and grow your
                business.
              </p>
          ...
          >
            <div className="max-w-md mx-auto">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">Join thousands of industry professionals</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <motion.div className="space-y-2" variants={fadeInUpVariants} custom={0.4}>
                ...
                <motion.div className="space-y-2" variants={fadeInUpVariants} custom={0.5}>
                ...
                <motion.div className="space-y-2" variants={fadeInUpVariants} custom={0.6}>
                ...
                <motion.div className="flex items-start space-x-2" variants={fadeInUpVariants} custom={0.7}>
                  <Checkbox
                    id="terms"
                    checked={agreeTerms}
                  ...
                  <Label htmlFor="terms" className="text-sm font-normal cursor-pointer text-gray-600">
                    I agree to the{" "}
                    <Link href="/terms" className="text-accent hover:text-accent-dark transition-colors duration-500">
                      Terms of Service
                    </Link>{" "}
                    and{" "}
                    <Link href="/privacy" className="text-accent hover:text-accent-dark transition-colors duration-500">
                      Privacy Policy
                    </Link>
                  </Label>
                </motion.div>

                <motion.div variants={fadeInUpVariants} custom={0.8}>
                  <Button
                    type="submit"
                ...
                <motion.div className="text-center text-sm text-gray-600" variants={fadeInUpVariants} custom={0.9}>
              ...
              <motion.div className="mt-8" variants={fadeInUpVariants} custom={1.0}>
                <div className="relative">
